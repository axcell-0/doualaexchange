...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Login success – later you can store token / session
      console.log("Logged in user:", data.user);
      setIsLoading(false);
      router.push("/main"); // or dashboard
    } catch (err) {
      console.error(err);
  ...
  return (
    <>
     {/* You can add a hero banner or image here */}
     <div className="bg-gray-500 dark:bg-[#102216]"></div>
        ...
        flex flex-col gap-2 mt-4 mb-6 text-center px-4">
            Please enter your registered email account and password to access your dashboard.
        </p>
